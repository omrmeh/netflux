...
INSERT INTO REALISATEUR(P_NAME, P_SURNAME, P_BIRTH, P_COUNTRY) Values ('Arnold', 'Newt', '01/01/1922', 'USA'); --1
INSERT INTO REALISATEUR(P_NAME, P_SURNAME, P_BIRTH, P_COUNTRY) Values ('Maïwenn', 'Le Besco', '01/01/1976', 'France'); --2
INSERT INTO REALISATEUR(P_NAME, P_SURNAME, P_BIRTH, P_COUNTRY) Values ('Peter', 'Jackson', '01/01/1961', 'Nouvelle Zelande'); --3
INSERT INTO REALISATEUR(P_NAME, P_SURNAME, P_BIRTH, P_COUNTRY) Values ('James', 'Cameron', '01/01/1954', 'Canada'); --4
INSERT INTO REALISATEUR(P_NAME, P_SURNAME, P_BIRTH, P_COUNTRY) Values ('William', 'Friedkin', '01/01/1935', 'USA'); --5
INSERT INTO REALISATEUR(P_NAME, P_SURNAME, P_BIRTH, P_COUNTRY) Values ('Garry', 'Marshall', '01/01/1934', 'USA'); --6
INSERT INTO REALISATEUR(P_NAME, P_SURNAME, P_BIRTH, P_COUNTRY) Values ('Tom', 'McGrath', '01/01/1964', 'USA'); --7 (mada 1)
INSERT INTO REALISATEUR(P_NAME, P_SURNAME, P_BIRTH, P_COUNTRY) Values ('Eric', 'Darnell', '01/01/1961', 'USA'); --8 (mada2)