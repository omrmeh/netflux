...
--Table des films
INSERT INTO FILM(ID_GENRE, F_TITLE, F_YEAR, F_RATINGS, F_POSTER, F_SYNOPSIS, F_LENGTH) 
Values (
1, 'Bloodsport - Tous les coups sont permis', 1988, 3, 'http://image.tmdb.org/t/p/w1280/E4d48dFICxN1tcGywt1p5zBHYJ.jpg', 
...
INSERT INTO FILM(ID_GENRE, F_TITLE, F_YEAR, F_RATINGS, F_POSTER, F_SYNOPSIS, F_LENGTH) 
Values (
8, 'Polisse', 2011, 3, 'http://image.tmdb.org/t/p/w1280/cKs3XSFVbFeZcH3g9geAvr6ApOl.jpg', 
...
INSERT INTO FILM(ID_GENRE, F_TITLE, F_YEAR, F_RATINGS, F_POSTER, F_SYNOPSIS, F_LENGTH) 
Values (
2, 'Le seigneur des anneaux: La communauté de l''anneau', 2011, 3, 'http://image.tmdb.org/t/p/w1280/56zTpe2xvaA4alU51sRWPoKPYZy.jpg', 
...
INSERT INTO FILM(ID_GENRE, F_TITLE, F_YEAR, F_RATINGS, F_POSTER, F_SYNOPSIS, F_LENGTH) 
Values (
3, 'Terminator', 1985, 3, 'http://image.tmdb.org/t/p/w1280/q8ffBuxQlYOHrvPniLgCbmKK4Lv.jpg', 
...
INSERT INTO FILM(ID_GENRE, F_TITLE, F_YEAR, F_RATINGS, F_POSTER, F_SYNOPSIS, F_LENGTH) 
Values (
4, 'L''Exorciste', 1974, 3, 'http://image.tmdb.org/t/p/w1280/4ucLGcXVVSVnsfkGtbLY4XAius8.jpg', 
...
INSERT INTO FILM(ID_GENRE, F_TITLE, F_YEAR, F_RATINGS, F_POSTER, F_SYNOPSIS, F_LENGTH) 
Values (
5, 'Pretty Woman', 1990, 3, 'http://image.tmdb.org/t/p/w1280/fgmdaCMxXClZm2ePteLzCPySB1n.jpg', 
...
INSERT INTO FILM(ID_GENRE, F_TITLE, F_YEAR, F_RATINGS, F_POSTER, F_SYNOPSIS, F_LENGTH) 
Values (
6, 'Madagascar', 2005, 3, 'http://image.tmdb.org/t/p/w1280/2YiESGB68BGQSAFvfJxBi774sc4.jpg', 
...
INSERT INTO FILM(ID_GENRE, F_TITLE, F_YEAR, F_RATINGS, F_POSTER, F_SYNOPSIS, F_LENGTH) 
Values (
6, 'Madagascar', 2007, 3, 'https://www.imdb.com/title/tt0351283/mediaviewer/rm2831549952', 
'Lorsqu’’un lion, un zèbre, une girafe, un hippopotame et une poignée de pingouins psychotiques fuient leur zoo new-yorkais pour secourir l’’un des leurs, l’’aventure s’’écrit avec un grand A. Et lorsque le destin les réunit sur l’’île de Madagascar, ils doivent apprendre en formation accélérée les rudiments de la vie à l’’air libre.', 
119);
